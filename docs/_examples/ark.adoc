...
----
<1> Alice adds her signature to the redeem transaction
<2> Alice broadcasts redeem transaction
<3> Alice now spends the output of the redeem transaction after timeout
