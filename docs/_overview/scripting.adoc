...
the link:/reference#script_interpolation[Script interpolation] section
...
There are a number of commands that are interpolated in script, see
the link:/reference#interpolated-miniscript-policy[Interpolated miniscript policy] section of the
