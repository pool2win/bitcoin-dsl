...
@alice_offered_htlc = %(OP_DUP OP_HASH160 hash160(@bob_revocation_key) OP_EQUAL
OP_IF
    OP_CHECKSIG
OP_ELSE
...
@alice_commitment_tx = transaction inputs: [
                                   ...
                                   outputs: [
                                     { script: @alice_local, amount: 48.999.sats },
                                     { script: @alice_remote, amount: 49.999.sats },
                                     { script: @alice_offered_htlc, amount: 1.sats }
                                   ]
...
@bob_commitment_tx = transaction inputs: [
                                 ...
                                 outputs: [
                                   { script: @bob_local, amount: 48.999.sats },
                                   { script: @bob_remote, amount: 49.999.sats },
                                   { script: @bob_received_htlc, amount: 1.sats }
                                 ]
