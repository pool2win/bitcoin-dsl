...
=== COMING SOON: Run a Jupyter Notebook 

[source,bash]
----
docker run -p 8888:8888 ghcr.io/pool2win/bitcoin-dsl:release
----

Look up the URL output by jupter and paste it into your browser
location bar. You know the drill.
