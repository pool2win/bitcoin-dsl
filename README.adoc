...
[source,ruby]
----
include::lib/contracts/multisig.rb[tag=setup]
----

.Spend coinbase to multisig
[source,ruby]
----
include::lib/contracts/multisig.rb[tag=spend-coinbase]
----

.Spend multisig after signing
[source,ruby]
----
include::lib/contracts/multisig.rb[tag=spend-multisig]
----
...
Miniscript is a nice tool for writing locking conditions in a higher
level language, however, we also want to enable writing unlocking
...
. Generating coinbase to a miniscript policy.
